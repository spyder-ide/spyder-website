...
<div class="download container max-w-4xl mt-32">
  ...
  {:else if os !== "unknown"}
    <h1 class="text-center text-4xl font-extralight mb-16">Download started&hellip;</h1>
  ...
  {#if osButtons}
    <div class="border-t border-t-mine-shaft-300 dark:border-t-mine-shaft-600 mt-8">
      <div class="text-neutral-500 text-xs font-medium mt-4 text-center">
        Available for
      </div>
      <div class="mx-auto max-w-md mt-4 mb-5 grid grid-cols-1 lg:grid-cols-2 items-center justify-center gap-4">
