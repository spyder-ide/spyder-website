...
![Pane Menu](/assets/media/pane-menu.png)

![Header Menu](/assets/media/header-menu.png)
...
![File associations](/assets/media/file-associations.png)
...
![Open With](/assets/media/open-with.png)
...
![Single click](/assets/media/single-click.png)
...
![Open Externally](/assets/media/open-externally.png)
...
![Select Files](/assets/media/select-files.png)
...
![Copy Path](/assets/media/copy-path.png)
...
![Relative Path](/assets/media/relative-path.png)
...
![File Extensions](/assets/media/file-extensions.png)
