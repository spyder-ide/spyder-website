...
![Python Viewer](/assets/media/python-viewer.png)
...
![Python Viewer Metadata](/assets/media/python-viewer-metadata.png)
...
![Exclude callables modules](/assets/media/exclude-callables-modules.png)
...
![View object explorer](/assets/media/view-object-explorer.png)
...
![Multi-index support](/assets/media/multi-index-support.png)
...
![Table headings](/assets/media/table-headings.png)
...
![Filter variables](/assets/media/filter-variables.png)
...
![Refresh](/assets/media/refresh.png)
...
![Screenshot of Spyder Variable Explorer UI, showing a Python set displayed in a native viewer](/assets/media/set-support.png)
