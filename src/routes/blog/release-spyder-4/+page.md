...
I decided to wait until now to write a blogpost about it because shortly after the initial release, we found several critical performance issues and some regressions with respect to Spyder 3, most of which are fixed now in [version 4.1.3](https://github.com/spyder-ide/spyder/releases/tag/v4.1.3), released on May 8th 2020.
...
The interested reader can take a look at some of them in [previous](https://www.spyder-ide.org/blog/spyder-variable-explorer/) [blog](https://www.spyder-ide.org/blog/spyder-files-improvements/) [posts](https://www.spyder-ide.org/blog/spyder-kite-funding/), and in detail in our [Changelog](https://github.com/spyder-ide/spyder/blob/master/CHANGELOG.md#version-400-2019-12-06).
